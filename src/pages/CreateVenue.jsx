          ...
          {media.length > 1 ? (
            ...
            >
              {media.map((mediaItem, index) => (
                <img
                  key={index + mediaItem.alt + Math.random(10) + "media-image"}
                  src={mediaItem.url}
                  alt={mediaItem.alt}
        ...
        <div className="flex container-image-boxes mx-5 sm:max-w-1/2 flex-row flex-wrap mb-4">
          {mediaFields.map((mediaItem, index) => (
            <div
              ...
              key={index + mediaItem.id + Math.random(10) + "media-field"}
            >
            ...
            <div className="location flex gap-3 items-start flex-col pt-sans-regular text-gray-700 font-light">
              ...
              <div className="flex flex-row flex-wrap gap-2">
                ...
                <input
                  ...
                  className="border rounded w-full  p-2 mb-2"
                />
                <label htmlFor="zip" className="text-sm font-regular">
                  Zip Code
                </label>
                <input
                  id="zip"
                  ...
                  placeholder="100-0006"
                  className="border rounded w-full  p-2 mb-2"
                />
                <label htmlFor="continent" className="text-sm font-regular">
                  Continent
                </label>
                <input
                  id="continent"
          ...
          <div className="md:w-1/2 w-full px-8 md:p-6 p-0 pb-6 flex flex-col">
            <div className="flex flex-col justify-end gap-2 items-start md:items-end pt-0 md:pt-0 md:px-8 md:p-6">
              ...
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="rating"
                  className="text-sm font-regular text-end"
                >
                  Venue Rating
                </label>
                <input
